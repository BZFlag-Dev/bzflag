...
public:
	...
	void setModulateColor( GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f );
	void setModulateColor( const GLfloat *rgba );
	void setLightedColor( GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f );
	void setLightedColor( const GLfloat *rgba );
	void setLightedModulateColor( GLfloat r, GLfloat g, GLfloat b, GLfloat a = 1.0f );
	...
	static int splitWall( const GLfloat *plane, const GLfloat3Array &vertices, const GLfloat2Array &uvs, SceneNode * &front, SceneNode * &back ); // const

private:
	static void splitEdge( float d1, float d2, const GLfloat *p1, const GLfloat *p2, const GLfloat *uv1, const GLfloat *uv2, GLfloat *p, GLfloat *uv ); //const
