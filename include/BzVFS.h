...
#define BZVFS_BASIC  BZVFS_CONFIG BZVFS_MEDIA

#define BZVFS_ALL  BZVFS_BASIC BZVFS_LUA_READ BZVFS_LUA_WRITE
...
class BzFile { // FIXME -- not implemented (use [io]stream's ?)
  public:
    BzFile();
    virtual ~BzFile();
...
class BzVFS {
  ...
  public:
    ...
    static bool createPathDirs(const std::string& root,
