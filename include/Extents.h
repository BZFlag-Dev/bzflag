...
{
	if(( mins[0] > test.maxs[0] ) || ( maxs[0] < test.mins[0] ) || ( mins[1] > test.maxs[1] ) || ( maxs[1] < test.mins[1] ) || ( mins[2] > test.maxs[2] ) || ( maxs[2] < test.mins[2] ))
	{
		return false;
	}
	return true;
...
{
	if(( mins[0] < test.mins[0] ) && ( maxs[0] > test.maxs[0] ) && ( mins[1] < test.mins[1] ) && ( maxs[1] > test.maxs[1] ) && ( mins[2] < test.mins[2] ) && ( maxs[2] > test.maxs[2] ))
	{
		return true;
	}
	return false;
