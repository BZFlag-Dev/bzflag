...
public:
	 ...
	 */
	std::istream *createDataInStream( const std::string &filename, bool binary = false )const;
	 ...
	 */
	std::ostream *createDataOutStream( const std::string &filename, bool binary = false, bool truncate = true )const;
