...
const uint16_t      MsgAcceptWorld = 0x6177;        // 'aw'
const uint16_t      MsgSetWorld = 0x736D;           // 'sm'
const uint16_t      MsgGetWorld = 0x6777;           // 'gw'
const uint16_t      MsgStartWorld = 0x7377;         // 'sw'
const uint16_t      MsgEndWorld = 0x6577;           // 'ew'
const uint16_t      MsgWorldChunk = 0x7763;         // 'wc'
