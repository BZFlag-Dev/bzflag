...
const char *const DefaultMOTDServer = "http://playground.bzflag.bz/motd.php";
...
{
	IsRegistered = 1 << 0, IsVerified = 1 << 1, IsAdmin = 1 << 2
};
...
enum BlowedUpReason
{
	GotKilledMsg, GotShot, GotRunOver, GotCaptured, GenocideEffect, SelfDestruct, WaterDeath, PhysicsDriverDeath, LastReason
};
