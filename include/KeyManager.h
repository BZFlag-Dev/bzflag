...
{
public:
	typedef void( *IterateCallback )( const std::string &name, bool press, const std::string &cmd, void *userData );
...
private:
	void notify( const BzfKeyEvent &, bool press, const std::string &cmd );
...
private:
	...
	{
public:
		bool operator()( const BzfKeyEvent &, const BzfKeyEvent & )const;
	};
