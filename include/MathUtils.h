...
public:
	...
	static void optimize()
	{
		...
		float( *mathTest[6] )( float ) = 
		{
			fastsqrt0, fastsqrt1, fastsqrt0, fastinvsqrt0, fastinvsqrt1, fastinvsqrt0
		};
		const char *label[6] = 
		{
			"system square root", "nvidia square root estimate", "hardware-based square root", "system inverse square root", "nvidia inverse square root estimate", "harware-based inverse square root"
		};
...
/* static initializers */
unsigned int math_util::_fast_sqrt_table[0x10000] = 
{
	0
};
bool math_util::_built_fast_sqrt_table = false;
float math_util::_random_floats[0x10000] = 
{
	0
};
