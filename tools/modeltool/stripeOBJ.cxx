...
*/
//
// stripeOBJ.cpp : reader for the OBJ files from tripe
//
//
...
static void readStripeMTL ( CModel &model, std::string file )
{
...
void readStripeOBJ ( CModel &model, std::string file )
{
  model.clear();
