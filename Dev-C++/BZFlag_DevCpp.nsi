...
;Dev-C++ specific installation script
;  MinGW and SDL are used in this version
;  and require different treatment than
;  the MSVC 7.1 builds.
;Modified for Dev-C++ builds of BZFlag
;  by UL_Approved
...
; File bzflag.exe.manifest
  ...
  ; Add some DLL files
  ; This assumes that you place libcurl-3.dll and SDL.dll in the base directory for the BZFlag source
  SetOutPath $INSTDIR
  File ..\..\..\libcurl-3.dll
  File ..\..\..\SDL.dll
...
SectionGroup "BZFlag Server" BZFlagServer
  ...
  Section "Plugins" BZFlagServer_Plugins
    ; Include the plugins
    SetOutPath $INSTDIR
    ; Use a nonfatal parameter in case no plugins were compiled
    File /nonfatal ..\..\..\plugins\*.dll
  SectionEnd

; This section can be uncommented once a Dev-C++ API actually exists...
; Section "Plugin API" BZFlagServer_PluginAPI
    ; Add the API library and header
;   SetOutPath $INSTDIR\API
;   File ..\..\..\src\bzfs\bzfs.a
