/*
 * bzflag Copyright (c) 1993 - 2009 Tim Riker This package is free
 * software; you can redistribute it and/or modify it under the terms of
 * the license found in the file named LICENSE that should have
...
static const int RRpacketHdrSize =
...
static const int ReplayHeaderSize =
...
//FIXME      useEmail = false;
  ...
  printf("offset:    %i\n", header.offset);
  printf
      ("length:    %-i days, %i hours, %i minutes, %i seconds, %i usecs\n",
...
//FIXME  MsgStrings::showEmail(useEmail);
  ...
  do {
    ...
    if ((p->mode == RealPacket) || (p->mode == HiddenPacket)
      ...
      std::cout << strRRtime(p->
                             timestamp) << ": UPDATE PACKET" << std::endl;
    }
