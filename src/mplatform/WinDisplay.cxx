								...
								charCode(0)
{
	...
	// if we're using a 3Dfx card then use passthrough mode
	if (GetModuleHandle("glide2x.dll") != NULL)
		setPassthrough(true);
...
bool					WinDisplay::doSetDefaultResolution()
{
...
{
	// not all versions of windows can dynamically change bit depth.
