...
public:
	XDisplay(const char* displayName, XDisplayMode* adoptedModeChanger = NULL);
	~XDisplay();
	...
	public:
		...
		// set/get current mouse position.  XDisplay::getEvent()
		// calls setMouse() whenever it handles a MotionNotify.
...
private:
	...
	bool				getKey(XEvent&, BzfKeyEvent&) const;
