...
BoltSceneNode::BoltSceneNode( const GLfloat pos[3] ): drawFlares( false ), texturing( false ), colorblind( false ), size( 1.0f ), renderNode( this )
{
...
void BoltSceneNode::move( const GLfloat pos[3], const GLfloat[3] )
{
	setCenter( pos );
...
BoltSceneNode::BoltRenderNode::BoltRenderNode( const BoltSceneNode *_sceneNode ): sceneNode( _sceneNode ), numFlares( 0 )
{
