...
EighthDBoxSceneNode::EighthDBoxSceneNode( const float pos[3], const float size[3], float rotation ): EighthDimSceneNode( BoxPolygons ), renderNode( this, pos, size, rotation )
{
	// get rotation stuff
...
EighthDBoxSceneNode::EighthDBoxRenderNode::EighthDBoxRenderNode( const EighthDBoxSceneNode *_sceneNode, const float pos[3], const float size[3], float rotation ): sceneNode( _sceneNode )
{
	// get rotation stuff
	const float c = cosf( rotation );
	const float s = sinf( rotation );
