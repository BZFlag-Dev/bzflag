...
TracerSceneNode::TracerSceneNode( const GLfloat pos[3], const GLfloat forward[3] ): renderNode( this )
{
	// prepare light
...
void TracerSceneNode::move( const GLfloat pos[3], const GLfloat forward[3] )
{
	const GLfloat d = 1.0f / sqrtf( forward[0] *forward[0] + forward[1] *forward[1] + forward[2] *forward[2] );
	...
	setCenter( pos[0] - 0.5f * TailLength * d * forward[0], pos[1] - 0.5f * TailLength * d * forward[1], pos[2] - 0.5f * TailLength * d * forward[2] );
...
TracerSceneNode::TracerRenderNode::TracerRenderNode( const TracerSceneNode *_sceneNode ): sceneNode( _sceneNode )
{
	// do nothing
}
