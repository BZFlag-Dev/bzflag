...
ShellSceneNode::ShellSceneNode( const GLfloat pos[3], const GLfloat forward[3] ): renderNode( this )
{
	static const GLfloat specular[3] = 
	{
		1.0f, 1.0f, 1.0f
	};
	static const GLfloat emissive[3] = 
	{
		0.0f, 0.0f, 0.0f
	};
...
void ShellSceneNode::move( const GLfloat pos[3], const GLfloat forward[3] )
{
	setCenter( pos );
...
ShellSceneNode::ShellRenderNode::ShellRenderNode( const ShellSceneNode *_sceneNode ): sceneNode( _sceneNode ), lighted( false )
{
	// do nothing
}
