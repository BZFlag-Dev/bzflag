 ...
 */
	...
	glVertex3f(0.007f, 1.110f, 1.940f);
	...
	glNormal3f(-0.238331f, -0.968849f, 0.067303f);
	glTexCoord2f(0.546f, 0.156f);
	glVertex3f(0.001f, -1.110f, 1.940f);
	glNormal3f(0.079953f, 0.000000f, 0.996799f);
	glTexCoord2f(1.080f, 0.169f);
	glVertex3f(-1.370f, 0.764f, 2.050f);
	glTexCoord2f(0.812f, -0.134f);
	glVertex3f(0.007f, 1.110f, 1.940f);
	...
	glNormal3f(0.094595f, 0.000000f, 0.995516f);
	glTexCoord2f(0.546f, 0.156f);
	glVertex3f(0.001f, -1.110f, 1.940f);
	glTexCoord2f(0.812f, -0.134f);
	glVertex3f(0.007f, 1.110f, 1.940f);
	...
	glNormal3f(0.149229f, -0.988713f, 0.013310f);
	glTexCoord2f(0.458f, 0.244f);
	glVertex3f(0.014f, -1.100f, 1.030f);
	glNormal3f(0.369158f, -0.927898f, 0.052229f);
	glTexCoord2f(0.107f, -0.009f);
	glVertex3f(1.480f, -0.516f, 1.040f);
	glNormal3f(0.381395f, -0.924109f, 0.023687f);
	glTexCoord2f(0.224f, -0.178f);
	glVertex3f(1.580f, -0.434f, 1.790f);
	glNormal3f(-0.085139f, -0.996296f, -0.012079f);
	glTexCoord2f(0.546f, 0.156f);
	glVertex3f(0.001f, -1.110f, 1.940f);
	glTexCoord2f(0.559f, 0.339f);
	glVertex3f(-0.456f, -1.060f, 1.040f);
      glEnd();
      glBegin(GL_TRIANGLE_FAN);
	glNormal3f(0.222340f, 0.974751f, 0.020603f);
	glTexCoord2f(0.895f, -0.226f);
	glVertex3f(0.014f, 1.100f, 1.030f);
	glNormal3f(-0.042797f, 0.999020f, -0.011269f);
	glTexCoord2f(0.996f, -0.132f);
	glVertex3f(-0.456f, 1.080f, 1.040f);
	glNormal3f(0.179990f, 0.983622f, -0.009585f);
	glTexCoord2f(0.812f, -0.134f);
	glVertex3f(0.007f, 1.110f, 1.940f);
	glNormal3f(0.369189f, 0.927954f, 0.050994f);
	glTexCoord2f(0.457f, -0.429f);
	glVertex3f(1.580f, 0.435f, 1.790f);
	glTexCoord2f(0.617f, -0.559f);
	glVertex3f(1.480f, 0.516f, 1.040f);
