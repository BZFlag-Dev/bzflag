...
PhotonTorpedoSceneNode::PhotonTorpedoSceneNode( const GLfloat pos[3] ): renderNode( this )
{
...
void PhotonTorpedoSceneNode::move( const GLfloat pos[3], const GLfloat[3] )
{
	setCenter( pos );
...
void PhotonTorpedoSceneNode::addLight( SceneRenderer &renderer )
{
...
void PhotonTorpedoSceneNode::addRenderNodes( SceneRenderer &renderer )
{
...
PhotonTorpedoSceneNode::PTRenderNode::PTRenderNode( const PhotonTorpedoSceneNode *_sceneNode ): sceneNode( _sceneNode ), numFlares( 0 )
{
...
{
	static const GLfloat mainColor[3] = 
	{
		1.0f, 0.2f, 0.0f
	};
	static const GLfloat innerColor[3] = 
	{
		1.0f, 0.5f, 0.375f
	};
	...
	static const GLfloat flareColor[4] = 
	{
		1.0f, 0.2f, 0.0f, 0.667f
	};
	static const GLfloat coronaColor[4] = 
	{
		1.0f, 0.2f, 0.0f, 0.333f
	};
