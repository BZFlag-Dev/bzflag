...
class EventClient
{
  ...
  public:
    ...
    virtual void RecvChatMsg(const std::string& /*msg*/, int /*srcID*/, int /*dstID*/, bool /*action*/) { return; }
    ...
    virtual bool KeyPress(bool /*taken*/, int /*key*/, int /*mods*/)           { return false; }
    virtual bool KeyRelease(bool /*taken*/, int /*key*/, int /*mods*/)         { return false; }
    virtual bool UnicodeText(bool /*taken*/, uint32_t /*unicode*/)             { return false; }
...
class DummyEventClient : public EventClient {
  private:
    DummyEventClient() : EventClient("DUMMY", 0, 0, 0, 0, true, true, true) {}
    DummyEventClient(const DummyEventClient&);
    DummyEventClient& operator=(const DummyEventClient&);
    ~DummyEventClient() {}
  public:
    static DummyEventClient instance;
};
