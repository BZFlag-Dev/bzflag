...
void CustomWeapon::writeToWorld( WorldInfo *world )const
{
	...
	{
		world->addWeapon( type, pos, rotation, tilt, teamColor, initdelay, delay, sync );
	}
	else
	{
		WorldWeaponGlobalEventHandler *eventHandler = new WorldWeaponGlobalEventHandler( type, pos, rotation, tilt, ( TeamColor )eventTeam );
