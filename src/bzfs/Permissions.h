...
public:
	...
	enum AccessPerm
	{
		actionMessage = 0, adminMessageReceive, adminMessageSend, antiban, antikick, antikill, antipoll, antipollban, antipollkick, antipollkill, ban, banlist, countdown, date, endGame, flagHistory, flagMaster, flagMod, hideAdmin, idleStats, info, kick, kill, lagStats, lagwarn, jitterwarn, listPerms, masterBan, modCount, mute, playerList, poll, pollBan, pollKick, pollKill, pollSet, pollFlagReset, privateMessage, record, rejoin, removePerms, replay, requireIdentify, say, sendHelp, setAll, setPassword, setPerms, setVar, shortBan, showOthers, shutdownServer, spawn, superKill, talk, unban, unmute, veto, viewReports, vote, 
