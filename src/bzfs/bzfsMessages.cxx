...
void flagToAPIFlag( FlagInfo &flag, bz_FlagUpdateRecord *flagRecord )
{
	...
	flagRecord->position[0] = flag.flag.position[0];
	flagRecord->position[1] = flag.flag.position[1];
	flagRecord->position[2] = flag.flag.position[2];
	flagRecord->launchPosition[0] = flag.flag.launchPosition[0];
	flagRecord->launchPosition[1] = flag.flag.launchPosition[1];
	flagRecord->launchPosition[2] = flag.flag.launchPosition[2];
	flagRecord->landingPosition[0] = flag.flag.landingPosition[0];
	flagRecord->landingPosition[1] = flag.flag.landingPosition[1];
	flagRecord->landingPosition[2] = flag.flag.landingPosition[2];
...
int sendPlayerUpdateDirect( NetHandler *handler, GameKeeper::Player *otherData )
{
	...
	return directMessage( handler, MsgAddPlayer, ( char* )buf - ( char* )bufStart, bufStart );
}
...
int sendTeamUpdateDirect( NetHandler *handler )
{
	...
	return directMessage( handler, MsgTeamUpdate, ( char* )buf - ( char* )bufStart, bufStart );
}
