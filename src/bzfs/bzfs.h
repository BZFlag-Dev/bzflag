...
extern void playerKilled(int victimIndex, BlowedUpReason reason, int16_t id, bool respawnOnBase = false);
extern void smitePlayer(int victimIndex, BlowedUpReason reason = GotKilledMsg, bool respawnOnBase = false);
