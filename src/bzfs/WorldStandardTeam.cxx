...
WorldInfo *defineTeamWorld()
{
	...
	baseSize[0][0] = 0.0f;
	baseSize[0][1] = 0.0f;
	basePos[1][0] = (-BZDB->eval("_worldSize") + BaseSize) / 2.0f;
	basePos[1][1] = 0.0f;
	basePos[1][2] = 0.0f;
	baseRotation[1] = 0.0f;
	baseSize[1][0] = BaseSize / 2.0f;
	baseSize[1][1] = BaseSize / 2.0f;
	basePos[2][0] = (BZDB->eval("_worldSize") - BaseSize) / 2.0f;
	basePos[2][1] = 0.0f;
	basePos[2][2] = 0.0f;
	baseRotation[2] = 0.0f;
	...
	basePos[3][0] = 0.0f;
	basePos[3][1] = (-BZDB->eval("_worldSize") + BaseSize) / 2.0f;
	basePos[3][2] = 0.0f;
	baseRotation[3] = 0.0f;
	baseSize[3][0] = BaseSize / 2.0f;
	baseSize[3][1] = BaseSize / 2.0f;
	basePos[4][0] = 0.0f;
	basePos[4][1] = (BZDB->eval("_worldSize") - BaseSize) / 2.0f;
	basePos[4][2] = 0.0f;
	baseRotation[4] = 0.0f;
