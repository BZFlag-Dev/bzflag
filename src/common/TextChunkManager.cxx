...
TextChunk::TextChunk(): fileName( "" ), maxLines(  - 1 ), maxLineLength(  - 1 )
{
...
bool TextChunkManager::parseFile( const std::string &fileName, const std::string &chunkName, const int maxLines, const int maxLineLength )
{
