...
BzfDisplay::BzfDisplay(): passWidth( 640 ), passHeight( 480 ), numResolutions( 0 ), defaultResolution(  - 1 ), currentResolution(  - 1 ), resolutions( NULL ), modeIndex(  - 1 )
{
	// do nothing
}
...
{
	if( index < 0 || index >= numResolutions )
		return NULL;
...
void BzfDisplay::initResolutions( ResInfo **_resolutions, int _numResolutions, int _currentResolution )
{
