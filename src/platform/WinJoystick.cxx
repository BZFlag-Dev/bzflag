...
void WinJoystick::getJoy( int &x, int &y )
{
	...
	switch( axes[xIndex].requestFlag )
	{
		...
		case JOY_RETURNV:
			...
			break;
		default:
			printError( "Failed to get Joystick X axis information" );
			break;
	}
	switch( axes[yIndex].requestFlag )
	{
		...
		case JOY_RETURNV:
			...
			break;
		default:
			printError( "Failed to get Joystick Y axis information" );
			break;
	}
...
unsigned long WinJoystick::getJoyButtons()
{
	...
	if( retbuts &JOY_BUTTON1 )
		buttons = buttons | 0x00001;
	if( retbuts &JOY_BUTTON2 )
		buttons = buttons | 0x00002;
	if( retbuts &JOY_BUTTON3 )
		buttons = buttons | 0x00004;
	if( retbuts &JOY_BUTTON4 )
		buttons = buttons | 0x00008;
	if( retbuts &JOY_BUTTON5 )
		buttons = buttons | 0x00010;
	if( retbuts &JOY_BUTTON6 )
		buttons = buttons | 0x00020;
	if( retbuts &JOY_BUTTON7 )
		buttons = buttons | 0x00040;
	if( retbuts &JOY_BUTTON8 )
		buttons = buttons | 0x00080;
	if( retbuts &JOY_BUTTON9 )
		buttons = buttons | 0x00100;
	if( retbuts &JOY_BUTTON10 )
		buttons = buttons | 0x00200;
