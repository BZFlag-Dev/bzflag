...
SolarisMedia::SolarisMedia(): BzfMedia(), audio_fd(  - 1 ), queueIn(  - 1 ), queueOut(  - 1 ), childProcID( 0 ), written( 0 ), eof_written( 0 ), eof_counter( 0 ), audio_ready( 0 )
...
bool SolarisMedia::startAudioThread( void( *proc )( void* ), void *data )
{
...
void SolarisMedia::writeAudioFrames( const float *samples, int numFrames )
{
...
void SolarisMedia::audioSleep( bool checkLowWater, double endTime )
{
