...
BzfDisplay *WinPlatformFactory::createDisplay( const char *name, const char *videoFormat )
{
	bool useNative = true;
#ifdef HAVE_SDL
...
BzfVisual *WinPlatformFactory::createVisual( const BzfDisplay *display )
{
	bool useNative = true;
#ifdef HAVE_SDL
	if( BZDB.isSet( "SDLVideo" ) && BZDB.isTrue( "SDLVideo" ))
...
BzfWindow *WinPlatformFactory::createWindow( const BzfDisplay *display, BzfVisual *visual )
{
	bool useNative = true;
#ifdef HAVE_SDL
	if( BZDB.isSet( "SDLVideo" ) && BZDB.isTrue( "SDLVideo" ))
