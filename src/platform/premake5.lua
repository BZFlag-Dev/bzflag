project "platform"
  ...
  filter { "system:linux", "options:with-sdl=no" }
    files { "LinuxPlatformFactory.cxx",
  ...
  filter "system:solaris"
    files { "SolarisPlatformFactory.cxx",
