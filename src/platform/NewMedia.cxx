...
bool NewMedia::startAudioThread( void( *proc )( void* ), void *data )
{
...
void NewMedia::writeAudioFrames( const float *samples, int numFrames )
{
...
void NewMedia::audioSleep( bool checkLowWater, double endTime )
{
