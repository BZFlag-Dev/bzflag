        ...
        float amplitude, float period, PeriodicType type)
{
    ...
    if (itr == effectDatabase.end())
    {
        ...
        switch (type)
        {
        case BzfJoystick::FF_Sine:
            guid = GUID_Sine;
            break;
        case BzfJoystick::FF_Square:
            guid = GUID_Square;
            break;
        case BzfJoystick::FF_Triangle:
            guid = GUID_Triangle;
            break;
        case BzfJoystick::FF_SawtoothUp:
            guid = GUID_SawtoothUp;
            break;
        case BzfJoystick::FF_SawtoothDown:
        ...
        float saturation, ResistanceType type)
{
    ...
    if (itr == effectDatabase.end())
    {
        ...
        switch (type)
        {
        case BzfJoystick::FF_Position:
            guid = GUID_Spring;
            break;
        case BzfJoystick::FF_Velocity:
            guid = GUID_Damper;
            break;
        case BzfJoystick::FF_Acceleration:
            guid = GUID_Inertia;
            break;
        default:
