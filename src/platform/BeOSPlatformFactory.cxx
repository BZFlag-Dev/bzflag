...
BzfDisplay *BeOSPlatformFactory::createDisplay( const char *name, const char *videoFormat )
{
...
BzfVisual *BeOSPlatformFactory::createVisual( const BzfDisplay *display )
{
...
BzfWindow *BeOSPlatformFactory::createWindow( const BzfDisplay *display, BzfVisual *visual )
{
	BeOSWindow *win;
