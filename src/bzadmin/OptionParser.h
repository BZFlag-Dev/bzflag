...
public:
	 ...
	 */
	Parser( const std::string &usageText, const std::string &helpText ): usage( usageText ), help( helpText ){}
	virtual ~Parser(){}
 ...
 */
template <class T> class VariableParser: public Parser
{
public:
	 ...
	 */
	VariableParser( T &variable, const std::string &usageText, const std::string &helpText ): Parser( usageText, helpText ), var( variable ){}
...
template <> class VariableParser<STRING> : public Parser
{
public:
	VariableParser( std::string &variable, const std::string &usageText, const std::string &helpText ): Parser( usageText, helpText ), var( variable ){}
	virtual int parse( char **argv )
	{
		var = argv[0];
		return 1;
...
{
public:
	VariableParser( bool &variable, const std::string &usageText, const std::string &helpText ): Parser( usageText, helpText ), var( variable ){}
...
template <class T> class VectorParser: public Parser
{
public:
	VectorParser( std::vector<T>  &variable, const std::string &usageText, const std::string &helpText ): Parser( usageText, helpText ), var( variable ){}
	virtual int parse( char **argv )
	{
...
public:
	 ...
	 */
	template <class T> bool registerVariable( const std::string &option, T &variable, const std::string &usage = "", const std::string &help = "" )
	{
	...
	template <class T> bool registerVector( const std::string &option, std::vector<T>  &variable, const std::string &usage = "", const std::string &help = "" )
	{
		//VC doesn't support out of class definition of template functions
