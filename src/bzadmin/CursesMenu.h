...
public:
	 ...
	 */
	virtual void showItem( WINDOW *menuWin, int line, int col, int width, bool selected );
...
public:
	 ...
	 */
	CommandCMItem( const std::string &str, const std::string &cmd, bool update = false );
...
public:
	...
	BoolCMItem( std::string name, bool &variable, std::string trueText = "true", std::string falseText = "false" );
