...
static void dumpServerList(Signal /*sig*/)
{
...
static void dumpTraffic(Signal /*sig*/)
{
...
int main(int argc, char** argv)
{
	...
	PLATFORM->signalCatch(kSigUSR1, dumpServerList);
	PLATFORM->signalCatch(kSigUSR2, dumpTraffic);
