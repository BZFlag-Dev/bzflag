...
OptionsMenu::OptionsMenu(): guiOptionsMenu( NULL ), effectsMenu( NULL ), cacheMenu( NULL ), saveWorldMenu( NULL ), inputMenu( NULL ), audioMenu( NULL ), displayMenu( NULL )
{
	// cache font face ID
...
void OptionsMenu::execute()
{
	...
	{
		if( !guiOptionsMenu )
			guiOptionsMenu = new GUIOptionsMenu;
	...
	{
		if( !saveWorldMenu )
			saveWorldMenu = new SaveWorldMenu;
