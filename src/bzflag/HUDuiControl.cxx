...
// init static members
const GLfloat HUDuiControl::dimTextColor[3] = 
{
	0.7f, 0.7f, 0.7f
};
const GLfloat HUDuiControl::moreDimTextColor[3] = 
{
	0.4f, 0.4f, 0.4f
};
const GLfloat HUDuiControl::textColor[3] = 
{
	1.0f, 1.0f, 1.0f
};
...
HUDuiControl::HUDuiControl(): showingFocus( true ), fontFace(  - 1 ), fontSize( 11 ), x( 0.0f ), y( 0.0f ), width( 1.0f ), height( 1.0f ), fontHeight( 11.0f ), desiredLabelWidth( 0.0f ), trueLabelWidth( 0.0f ), prev( this ), next( this ), cb( NULL ), userData( NULL )
{
	if( totalCount == 0 )
	{
		// load arrow texture
