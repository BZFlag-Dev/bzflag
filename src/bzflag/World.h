...
public:
	...
	bool crossingTeleporter( const float *oldPos, float angle, float tankWidth, float tankBreadth, float tankHeight, float *plane )const;
	...
	bool writeWorld( const std::string &filename, std::string &fullname );
