...
public:
	...
	void saveMessages( const std::string &filename, bool stripAnsi )const;
...
private:
	...
	enum MessageModes
	{
		MessageAllTabs =  - 2, MessageCurrent =  - 1, MessageAll = 0, MessageChat = 1, MessageServer = 2, MessageMisc = 3, MessageModeCount
	};
	bool tabsOnRight;
