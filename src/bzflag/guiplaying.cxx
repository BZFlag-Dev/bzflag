...
#define GL_QUERY_COMPARE(x) if (query == #x) { queryID = x; }

  // string queries
  GL_QUERY_COMPARE(GL_VENDOR);
  GL_QUERY_COMPARE(GL_VERSION);
  GL_QUERY_COMPARE(GL_RENDERER);
  GL_QUERY_COMPARE(GL_EXTENSIONS);
  GL_QUERY_COMPARE(GL_SHADING_LANGUAGE_VERSION);
  if (queryID != 0) {
  ...
  // integer queries
  GL_QUERY_COMPARE(GL_MAX_LIGHTS);
  GL_QUERY_COMPARE(GL_MAX_ATTRIB_STACK_DEPTH);
  GL_QUERY_COMPARE(GL_MAX_CLIENT_ATTRIB_STACK_DEPTH);
  GL_QUERY_COMPARE(GL_MAX_MODELVIEW_STACK_DEPTH);
  GL_QUERY_COMPARE(GL_MAX_PROJECTION_STACK_DEPTH);
  GL_QUERY_COMPARE(GL_MAX_TEXTURE_STACK_DEPTH);
  GL_QUERY_COMPARE(GL_MAX_TEXTURE_SIZE);
  GL_QUERY_COMPARE(GL_MAX_TEXTURE_UNITS);
  GL_QUERY_COMPARE(GL_MAX_TEXTURE_COORDS);
  GL_QUERY_COMPARE(GL_MAX_TEXTURE_IMAGE_UNITS);
  GL_QUERY_COMPARE(GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS);
  GL_QUERY_COMPARE(GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS);
  GL_QUERY_COMPARE(GL_MAX_ELEMENTS_VERTICES);
  GL_QUERY_COMPARE(GL_MAX_ELEMENTS_INDICES);
  GL_QUERY_COMPARE(GL_MAX_DRAW_BUFFERS);
  GL_QUERY_COMPARE(GL_MAX_SAMPLES);
  GL_QUERY_COMPARE(GL_RED_BITS);
  GL_QUERY_COMPARE(GL_BLUE_BITS);
  GL_QUERY_COMPARE(GL_GREEN_BITS);
  GL_QUERY_COMPARE(GL_ALPHA_BITS);
  GL_QUERY_COMPARE(GL_DEPTH_BITS);
  GL_QUERY_COMPARE(GL_STENCIL_BITS);
  if (queryID != 0) {
    GLint value;
