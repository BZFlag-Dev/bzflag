...
{
	return normalFired + guidedMissileFired + laserFired + superBulletFired + shockWaveFired + thiefFired;
}
...
{
	return normalHit + guidedMissileHit + laserHit + superBulletHit + shockWaveHit + thiefHit;
}
