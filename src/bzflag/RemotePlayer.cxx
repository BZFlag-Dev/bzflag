...
RemotePlayer::RemotePlayer( const PlayerId &_id, TeamColor _team, const char *_name, const char *_email, const PlayerType _type ): Player( _id, _team, _name, _email, _type )
{
