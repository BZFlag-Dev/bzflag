...
template <> ActionBinding *Singleton<ActionBinding>::_instance = ( ActionBinding* )0;
...
void ActionBinding::onScanCB( const std::string &name, bool, const std::string &cmd, void* )
{
