...
GuidedMissileStrategy::GuidedMissileStrategy( ShotPath *_path ): ShotStrategy( _path ), renderTimes( 0 ), needUpdate( true )
{
...
{
	const bool isRemote = ( getPath().getPlayer() != LocalPlayer::getMyTank()->getId());
