...
#endif // HAVE_KRB5
{
	...
	if( !retval )
		if(( retval = krb5_get_init_creds_password( context, &my_creds, client, intPassword, krb5_prompter_posix, NULL, 0, NULL, NULL )))
	...
	if( !retval )
		if(( retval = krb5_parse_name( context, "krbtgt/BZFLAG.ORG@BZFLAG.ORG",  &server )))
...
#endif // HAVE_KRB5
{
	...
	/* Get credentials for server */
	if(( retval = krb5_get_credentials( context, KRB5_GC_CACHED, cc, &creds,  &new_creds )))
