...
#define ADD_CI(n, bits, retType, singleScript) \
  ...
  ADD_CI(KeyPress,     REQ_INPUT_CTRL, BOOLEAN_OR,   ANY_SCRIPT);
  ADD_CI(KeyRelease,   REQ_INPUT_CTRL, BOOLEAN_OR,   ANY_SCRIPT);
  ADD_CI(UnicodeText,  REQ_INPUT_CTRL, BOOLEAN_OR,   ANY_SCRIPT);
  ADD_CI(MousePress,   REQ_INPUT_CTRL, BOOLEAN_OR,   ANY_SCRIPT);
  ADD_CI(MouseMove,    REQ_INPUT_CTRL, BOOLEAN_OR,   ANY_SCRIPT);
  ADD_CI(MouseRelease, REQ_INPUT_CTRL, BOOLEAN_OR,   ANY_SCRIPT);
  ADD_CI(MouseWheel,   REQ_INPUT_CTRL, BOOLEAN_OR,   ANY_SCRIPT);
