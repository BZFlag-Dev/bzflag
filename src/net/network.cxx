...
extern "C"
{
	...
	} netErrorCodes[] = 
	{
		...
		,  /* 10014 */
		{
			WSAEFAULT, "Invalid pointer value, or buffer is too small (WSAEFAULT)"
		}
		...
		,  /* 10035 */
		{
			WSAEWOULDBLOCK, "Socket is marked as non-blocking and no connections are present or the receive operation would block"
		}
		...
		,  /* 10051 */
		{
			WSAENETUNREACH, "The network can't be reached from this hos at this time"
		}
		...
		,  /* 10055 */
		{
			WSAENOBUFS, "No buffer space is available or a buffer deadlock has occured. The socket cannot be created"
		}
		...
		,  /* 11003 */
		{
			WSANO_RECOVERY, "Host name lookup error"
		}

		,  /* 11004 */
		{
			WSANO_DATA, "No data for host"
		}
...
bool BzfNetwork::parseURL( const std::string &url, std::string &protocol, std::string &hostname, int &port, std::string &pathname )
{
