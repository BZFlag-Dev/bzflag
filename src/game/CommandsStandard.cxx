...
static std::string cmdQuit( const std::string &, const CommandManager::ArgList &, bool* )
{
...
static std::string cmdHelp( const std::string &, const CommandManager::ArgList &args, bool* )
{
	switch( args.size())
	{
		case 0:
...
static std::string cmdPrint( const std::string &, const CommandManager::ArgList &args, bool* )
{
...
static std::string cmdSet( const std::string &, const CommandManager::ArgList &args, bool *error )
{
	if( error )
		 *error = false;
	switch( args.size())
...
static std::string cmdUnset( const std::string &, const CommandManager::ArgList &args, bool* )
{
	if( args.size() != 1 )
...
static void onBindCB( const std::string &name, bool press, const std::string &cmd, void *userData )
{
	std::string &result =  *static_cast < std::string * > ( userData );
	result += name;
...
static std::string cmdBind( const std::string &, const CommandManager::ArgList &args, bool* )
{
	if( args.size() == 0 )
	{
		std::string result;
...
static std::string cmdUnbind( const std::string &, const CommandManager::ArgList &args, bool* )
{
	if( args.size() != 2 )
...
static std::string cmdToggle( const std::string &, const CommandManager::ArgList &args, bool* )
{
