...
int ServerItem::getPlayerCount()const
{
	...
	if( &ping != 0 )
	{
		...
		curPlayer = ping.rogueCount + ping.redCount + ping.greenCount + ping.blueCount + ping.purpleCount + ping.observerCount;
...
unsigned int ServerItem::getSortFactor()const
{
	...
	if( &ping != 0 )
	{
		...
		value = ping.rogueCount + ping.redCount + ping.greenCount + ping.blueCount + ping.purpleCount;
		value *= 1000;
