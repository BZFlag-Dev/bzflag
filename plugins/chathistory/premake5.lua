project "chathistory"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)chathistory.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\chathistory\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\chathistory\\*.cfg ( copy ..\\..\\plugins\\chathistory\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
