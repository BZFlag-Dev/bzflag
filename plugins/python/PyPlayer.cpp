...
namespace Python
{
	...
	static PyObject *Player_getAttr( Player *player, char *name )
	{
		...
		{
			attr = Py_BuildValue( "[s,s,s,s,s,s,s,s,s,s,s,s,s,s,s]", "id", "callsign", "team", "position", "rotation", "ipAddr", "flag", "flagHistory", "spawned", "verified", "global", "admin", "groups", "wins", "losses" );
		}
	...
	static int Player_compare( Player *a1, Player *a2 )
	{
		return (( a1->record->playerID == a2->record->playerID ) && ( a1->record->callsign == a2->record->callsign ));
	}
