project "superUser"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)superUser.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\superUser\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\superUser\\*.cfg ( copy ..\\..\\plugins\\superUser\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
