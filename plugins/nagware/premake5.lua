project "nagware"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)nagware.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\nagware\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\nagware\\*.cfg ( copy ..\\..\\plugins\\nagware\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
