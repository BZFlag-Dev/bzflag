project "shockwaveDeath"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)shockwaveDeath.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\shockwaveDeath\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\shockwaveDeath\\*.cfg ( copy ..\\..\\plugins\\shockwaveDeath\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
