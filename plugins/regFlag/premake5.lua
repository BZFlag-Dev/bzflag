project "regFlag"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)regFlag.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\regFlag\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\regFlag\\*.cfg ( copy ..\\..\\plugins\\regFlag\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
