project "Phoenix"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)Phoenix.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\Phoenix\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\Phoenix\\*.cfg ( copy ..\\..\\plugins\\Phoenix\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
