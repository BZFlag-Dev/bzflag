project "rabbitTimer"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)rabbitTimer.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\rabbitTimer\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\rabbitTimer\\*.cfg ( copy ..\\..\\plugins\\rabbitTimer\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
