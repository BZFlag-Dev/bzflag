project "teamflagreset"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)teamflagreset.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\teamflagreset\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\teamflagreset\\*.cfg ( copy ..\\..\\plugins\\teamflagreset\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
