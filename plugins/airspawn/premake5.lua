project "airspawn"
  ...
  filter "system:windows"
    ...
    postbuildcommands {
      ...
      "copy $(OutDir)airspawn.dll ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "copy ..\\..\\plugins\\airspawn\\*.txt ..\\..\\bin_$(Configuration)_$(Platform)\\plugins\\",
      "if exist ..\\..\\plugins\\airspawn\\*.cfg ( copy ..\\..\\plugins\\airspawn\\*.cfg ..\\..\\bin_$(configuration)_$(Platform)\\plugins\\ )"
    }
